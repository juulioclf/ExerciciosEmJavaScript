...
console.log(jurosCalcular(600, 1.5, 3))
console.log('\n')
...
console.log(baskhara(3, -100, 12))
console.log(baskhara(3, -5, 0))
console.log(baskhara(2, 5, 2))
...
const pontuacao = arrayString => {
    let bateuSeuRecord = 0
    let piorJogo = 0
    let naoSei = 
